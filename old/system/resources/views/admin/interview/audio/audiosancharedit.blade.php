            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <form action="{{route('admin.update_audio')}} " class="form-horizontal" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="col-md-12 form-group">
                                ...
                                <textarea name="introduction" id="summernote" class="form-control editor {{ $errors->has('introduction') ? ' is-invalid' : '' }}">
                                    {{$edit->description}}
                                </textarea>
