            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <form action="{{route('admin.GatibidhiUpdate')}}" class="form-horizontal" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="col-md-12 form-group">
                                ...
                                <textarea name="description" id="summernote" rows="10" class="form-control  {{ $errors->has('description') ? ' is-invalid' : '' }}">{{ $editgatibidhi->description }}</textarea>
