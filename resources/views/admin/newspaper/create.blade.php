<x-app-layout>
    ...
    <div class="flex-auto p-6 bg-card  bg-white shadow-2xl">
        <div class="max-w-5xl">
            ...
            <form class="flex flex-col mt-4 px-8 pt-10 rounded overflow-hidden" method="POST" action="{{ route('admin.mass-communication.newspaper.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full md:w-1/2 px-3">
                        ...
                        class="block w-full text-gray-700 bg-white rounded py-3 px-4 border border-solid border-gray-300"                           
                         id="title_ne" name="title_ne" type="text" placeholder="शिर्षक नेपालीमा">
                        @error('title_ne')
                    ...
                    <div class="w-full md:w-1/2 px-3">
                        ...
                        <input
                        class="block w-full text-gray-700 bg-white rounded py-3 px-4 border border-solid border-gray-300"
                        id="title_en" name="title_en" type="text" placeholder="शिर्षक अंग्रेजीमा">
                            @error('title_en')
                            <p class="text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="flex flex-wrap -mx-3 mb-10">
                    <div class="w-full px-3">
                        ...
                        <textarea name="des_ne" id="1" cols="10" rows="30" class="ck_editor"></textarea>
                        @error('des_ne')
                            <p class="text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="flex flex-wrap -mx-3 mb-10">
                    <div class="w-full px-3">
                        ...
                        <textarea name="des_en" id="2" cols="10" rows="30" class="ck_editor"></textarea>
                        @error('des_en')
                            <p class="text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
