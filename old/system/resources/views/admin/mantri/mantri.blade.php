            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-action">
                        {{__('मन्त्रिमा हुदाँको विवरण थप्नुहोस')}}
                    </div>
                    <div class="card-content">
                        <form action="{{route('admin.addmantri')}}" class="form-horizontal" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="col-md-12 form-group">
                                ...
                                <textarea name="description" id="summernote" rows="10" class="form-control editor {{ $errors->has('description') ? ' is-invalid' : '' }}">{{ old('description') }}</textarea>
