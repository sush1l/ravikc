    ...
    <div class="flex-auto p-6 bg-card  bg-white shadow-2xl">
        <div class="max-w-5xl">
            <div class="prose prose-sm px-10 max-w-3xl my-3">
                <h4 class="mb-8 text-2xl">गतिविधि फारम</h4>
            </div>
            <form class="flex flex-col mt-4 px-8 pt-10 rounded overflow-hidden" method="POST" action="{{ route('admin.activity.store') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="flex flex-wrap -mx-3 mb-8">
                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                        ...
                        <input
                        class="block w-full text-gray-700 bg-white rounded py-3 px-4 border border-solid border-gray-300"                            id="photo" name="photo" type="file">
                            @error('photo')
                            <p class="text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="flex flex-wrap -mx-3 mb-10">
                    <div class="w-full px-3">
                        ...
                        <textarea name="desc_ne" id="1" cols="10" rows="30" class="ck_editor"></textarea>
                        @error('desc_ne')
                            <p class="text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="flex flex-wrap -mx-3 mb-10">
                    <div class="w-full px-3">
                        ...
                        <textarea name="desc_en" id="2" cols="10" rows="30" class="ck_editor"></textarea>
                        @error('desc_en')
                            <p class="text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
