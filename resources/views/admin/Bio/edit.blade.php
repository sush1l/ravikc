<x-app-layout>
    ...
    <div class="flex-auto p-6 bg-card  bg-white shadow-2xl">
        <div class="max-w-5xl">
            ...
            <form class="flex flex-col mt-4 px-8 pt-10 rounded overflow-hidden" method="POST" action="{{ route('admin.bio.update', $bio) }}" enctype="multipart/form-data">
                @csrf
                @method('put')
                ...
                <div class="flex flex-wrap -mx-3 mb-10">
                    <div class="w-full px-3">
                        ...
                        <textarea name="data" id="1" cols="10" rows="30" class="ck_editor">{{ old('data', $bio->data) }}</textarea>
                        @error('data')
                            <p class="text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
