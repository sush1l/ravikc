<x-app-layout>
    ...
    <div class="flex-auto p-6 bg-card  bg-white shadow-xl">
        <div class="max-w-5xl">
            ...
            <form class="flex flex-col mt-4 px-8 pt-10 rounded overflow-hidden" method="POST" action="{{ route('admin.gallery.store') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="flex flex-wrap -mx-3 mb-8">
                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                        ...
                        <input
                        class="block w-full text-gray-700 bg-white rounded py-3 px-4 border border-solid border-gray-300"      
                        id="photo" name="photo[]" type="file" multiple>
                            @error('photo')
                            <p class="text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
