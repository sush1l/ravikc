            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <form action="{{route('admin.add_video')}} " class="form-horizontal" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="col-md-8 form-group">
                                ...
                                <textarea name="file" id="file" cols="30" class=" form-control {{ $errors->has('file') ? ' is-invalid' : '' }}" rows="5">{{old('file')}}</textarea>
                                @if ($errors->has('file'))
                                    <span class="invalid-feedback" role="alert">
                        ...
                        <table class="table table-striped table-hover table-responsive" id="dataTables-example">
                            ...
                            @foreach($audio as $audio_sanchar)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('admin.videoedit',[$audio_sanchar->id])}}">
                                            <button class="btn btn-warning btn-sm">
                                                <i class="fa fa-pencil"></i>
                                            </button>
                                        </a>
                                        <a href="{{route('admin.videodelete',[$audio_sanchar->id])}}" onclick="return confirm('Are you sure you want to delete this item?');" title="Delete">
